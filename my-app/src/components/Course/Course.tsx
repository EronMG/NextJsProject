  ...
  return (
    <section className="px-[10px] pt-[77px] xx:pt-[270px]">
      <div className="xx:flex justify-center">
        <div className="flex flex-col lg:items-end xx:relative justify-center xx:justify-between items-center border-b-[2px] border-blue  lg:flex-row lg:pb-[10px] xx:w-[1576px]">
          <h2 className=" font-Regular text-dark text-[22px] leading-[26.4px] text-center max-w-[278px] xx:pb-[14px] ss:max-w-[450px] xx:text-[30px] xx:leading-[36.2px] lg:max-w-[1058px] lg:text-start bb:text-[36px] bb:leading-[41.6px] bb:max-w-[1198px]">
          ...
          <img
            src={Press.src}
            alt="icon"
            className="mt-[11px] xx:w-[260px] xx:h-[233px] xx:mr-20 xx:absolute right-[-4px]"
          />
        </div>
      </div>
      <div className="pt-3 flex flex-col items-center mm:pt-6 xx:pt-12">
        ...
        <div
          className="flex lg:max-w-[800px] lg:gap-10 overflow-hidden pt-[25px] max-w-[300px] md:flex-wrap md:max-w-[1576px] xx:max-w-[1920px] md:justify-center md:gap-3 xx:grid xx:grid-cols-2 xx:gap-5 xx:pt-[34px]"
          id="course"
        >
