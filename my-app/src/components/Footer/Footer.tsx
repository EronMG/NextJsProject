    ...
    <div className="xb:flex justify-center">
      <section className="mx-[10px] bg-dark rounded-t-[40px] py-[33px] mt-10 lg:mx-[5%] lg:px-[60px] lg:pt-[93px] xm:px-[80px] xm:pt-[137px] xm:rounded-t-[60px] xb:pb-[65px] xb:mt-[188px] max-w-[1738px]">
        <div className="relative flex flex-col items-center px-[10px] sm:flex-row  sm:justify-around lg:justify-start">
          ...
          <div className="hidden lg:flex xb:right-0 xb:top-[30.5%] xb:left-[28.8%]">
            <animated.div
              style={{
                ...styles,
                position: "absolute",
        ...
        <div className="hidden lg:flex justify-center rounded-[10px] mt-[196px]">
          <table className="rounded-[10px] table-auto border border-separate border-spacing-[0] border-cloud">
            <tbody className="">
              <tr className="">
                <td className="bg-cloud rounded-tl-[10px] border border-cloud xb:max-w-[439px]">
                  &nbsp;
                </td>
              ...
              <tr className="xm:h-[128px] align-top">
                <td className="text-white align-middle text-center font-Regular footer-table-ex-b border border-cloud px-[10px] ">
                  Без ИИ-ассистента
                </td>
              ...
              <tr className="h-[110px] align-top">
                <td className="rounded-bl-[10px] text-lime align-middle text-center font-Regular footer-table-ex-b border border-cloud px-[10px] ">
                  С ИИ-ассистентом
                </td>
