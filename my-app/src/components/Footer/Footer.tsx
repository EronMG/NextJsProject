...
const Footer = () => {
  ...
  return (
    <div className="xb:flex justify-center">
      <section className="mx-[10px] bg-dark rounded-t-[40px] md:mx-auto lg:mx-0 md:w-[696px] lg:w-full md:rounded-t-[26px] lg:rounded-t-[60px] py-[33px] md:py-0 md:pt-[26px] mt-10 md:px-[14px] md:mt-[64px] lg:px-[60px] lg:pt-[93px] xm:px-[80px] xm:pt-[137px] xm:rounded-t-[60px] xb:pb-[65px] xb:mt-[188px] xb:w-[1738px]">
