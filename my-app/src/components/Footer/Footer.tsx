...
const Footer = () => {
  ...
  return (
    <div className='xb:flex justify-center'>
      <section className='mx-[10px] bg-dark rounded-t-[40px] md:mx-auto lg:mx-0 md:w-[806px] lg:w-full md:rounded-t-[26px] lg:rounded-t-[60px] py-[33px] md:py-0 md:pt-[26px] mt-10 md:px-[14px] md:mt-[64px] lg:px-[60px] lg:pt-[93px] xm:px-[80px] xm:pt-[137px] xm:rounded-t-[60px] xb:pb-[65px] xb:mt-[188px] xb:w-[1738px]'>
        ...
        <div className='hidden md:flex justify-center md:rounded-[4.23px] lg:rounded-[10px] md:mt-[-20px] mt-[196px]'>
          <table className='md:rounded-[4.23px] max lg:rounded-[10px] table-auto border border-separate border-spacing-[0] border-cloud'>
            <tbody className=''>
        ...
        <div className='flex flex-col items-center lg:mt-[70px] md:mt-[19px]'>
          <div className='md:hidden mt-[71px] px-[10px]'>
