...
const Footer = () => {
  return (
    <section className="mx-[10px] bg-dark rounded-t-[40px] pt-[33px] mt-10">
      <div className="flex flex-col items-center px-[10px] sm:flex-row  sm:justify-around">
        <div className="max-w-[279px] sm:max-w-[300px] sm:h-[169px]">
          <h2 className="text-white text-[22px] leading-[26.4px] font-Regular text-center sm:text-left">
      ...
      <div className="flex flex-col items-center bg-cloud">
        <div className="flex justify-between w-full">
          <div className="w-[49.8%] h-[44px] flex justify-center items-center bg-blue">
        ...
        <div className="flex justify-center items-center h-[24px] sm:h-[44px]">
        ...
        <div className="flex justify-between w-full">
          <div className="w-[49.8%] h-[34px] flex justify-center items-center bg-dark">
        ...
        <div className="flex justify-center items-center h-[24px] sm:h-[44px]">
          <p className="footer-table-b leading-[16.8px] text-blue text-Regular sm:text-[22px]">
            Заявок обработано
          </p>
        </div>

        <div className="flex justify-between w-full">
          <div className="w-[49.8%] h-[31px] flex justify-center items-center bg-dark">
            <p className="footer-table-l leading-[15.6px] text-white text-Regular">
              440
            </p>
          </div>
        ...
        <div className="flex justify-between w-full">
          <div className="w-[49.8%] h-[33px] flex justify-center items-center bg-dark">
            <p className="footer-table-l leading-[15.6px] text-white text-Regular">
              2 менеджера
            </p>
          </div>
        ...
        <div className="flex justify-between w-full mb-[2px]">
          <div className="w-[49.8%] h-[75px] flex flex-col justify-center items-center bg-dark gap-[11px]">
            <p className="footer-table-l leading-[15.6px] text-white text-center text-Regular">
              136 ₽
            </p>
      ...
      <div className="flex flex-col items-center mt-[70px]">
        ...
        <div className="pt-6 sm:flex sm:flex-row">
          <div className="flex justify-center flex-col items-center">
            <img src={Comp.src} alt="computer" />
            <div className="w-[276px] flex justify-center items-center border-[1px] border-lime bg-[#1E2121] rounded-[10px] py-3 px-1 sm:hidden">
              <p className="text-white footer-table-b leading-[16.8px] text-center">
          ...
          <div className="hidden sm:flex sm:flex-col sm:items-center sm:pt-[30px]">
      ...
      <div className="flex-wrap flex justify-between items-center px-7 gap-[67px] pt-20 pb-10 sm:pt-10">
