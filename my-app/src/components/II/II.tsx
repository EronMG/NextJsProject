  ...
  return (
    <section className='pt-[71px] px-[10px] bb:pt-[180px] bb:px-0 lg:relative bb:flex justify-center lg:mb-[100px] bb:mb-0'>
      <div className='bb:w-[1920px] bb:relative'>
        <h2 className='text-[22px] leading-[26.4px] font-Regular text-center text-dark bb:text-[36px] lg:text-[26px] bb:leading-[43.2px] max-w-[979px] lg:text-start bb:ml-[170px]'>
