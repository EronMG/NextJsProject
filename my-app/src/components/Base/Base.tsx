...
const Base = () => {
  return (
    <div className='xx:flex justify-center'>
      <section className='mx-[10px] px-[10px] bg-cloud rounded-[10px] flex flex-wrap justify-center gap-4 mt-[71px] pt-2 xx:mt-[536px] xx:w-[1738px] xx:rounded-[20px] xx:pt-[76px] xx:gap-[70px]'>
        {/* FIX MT-500PX */}
