...
function Tryit() {
  ...
  return (
    <>
      <section className="flex flex-col xm:px-[10px] items-center md:items-center md:px-[96px] lg:ml-0 lg:justify-center bb:max-w-[1920px] mt-[80px] xx:mt-[180px] md:mt-[60px]">
