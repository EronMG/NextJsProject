...
function Links() {
  ...
  return (
    <>
      <section className="flex flex-col items-center mb-[40px] mt-[78px] overflow-hidden sm:flex-row sm:items-start sm:justify-between sm:px-[10px] md:pb-[0px] md:px-[70px] lg:pb-[40px] xl:pb-[0] xl:relative bb:pt-[102px]">
        ...
        <div className="hidden sm:flex sm:flex-col sm:gap-[85px] sm:items-end order-2 z-50 xx:h-[605px] xx:justify-start bb:h-[769px] bb:mt-[208px] bb:mr-[100px] bb:gap-[114px] bb:justify-start">
