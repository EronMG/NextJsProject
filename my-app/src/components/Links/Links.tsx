...
function Links() {
  ...
  return (
    <>
      <section className="flex flex-col items-center mt-[78px] overflow-hidden sm:flex-row sm:items-start sm:justify-between sm:px-[10px] md:pb-[20px] md:px-[70px] xl:relative bb:pt-[102px]">
        ...
        <div className="hidden sm:flex sm:flex-col sm:gap-[85px] sm:items-end order-2 z-50 xx:h-[605px] xx:justify-end bb:h-[797px] bb:mt-[208px] bb:mr-[100px] bb:gap-[114px] bb:justify-start">
          ...
          <div className="z-50 flex flex-row">
            ...
            <div className="hidden xl:flex xl:gap-[18px]">
