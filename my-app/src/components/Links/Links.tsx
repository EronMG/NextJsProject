...
function Links() {
  ...
  return (
    <>
      <section className="flex flex-col items-center mb-[40px] mt-[72px] overflow-visible sm:flex-row sm:items-start sm:justify-between sm:px-[10px] md:justify-end md:pb-[0px] md:mt-[60px] md:px-[50px] lg:pb-[40px] xl:pb-[50px] xl:relative bb:px-[70px] bb:pt-[102px]">
        ...
        <div className="relative md:absolute sm:order-1  md:left-[50px] bb:left-[95px] bb:top-[117px]">
          ...
          <div className="absolute ">
            {[
              ...
              <div
                ...
                ${
                  index === 2
                    ? "-top-[220px] left-[226px] md:-top-[256px] md:left-[259px] lg:-top-[333px] lg:left-[328px] xx:-top-[503px] xx:left-[490px] bb:-top-[656px] bb:left-[663px]"
                    : ""
                }
                ${
                  index === 3
                ...
                ${
                  index === 4
                    ? "-top-[156px] left-[217px] md:-top-[183px] md:left-[248px] lg:-top-[235px] lg:left-[320px] xx:-top-[350px] xx:left-[480px] bb:-top-[471px] bb:left-[637px]"
                    : ""
                }
                ${
                  index === 5
                ...
                ${
                  index === 6
                    ? "-top-[143px] -left-[17px] md:-top-[169px] md:-left-[21px] lg:-top-[220px] lg:-left-[21px] xx:-top-[320px] xx:-left-[35px] bb:-top-[432px] bb:-left-[52px]"
                    : ""
                }
                ${
                  index === 7
          ...
          <img
            src={HumanRobot.src}
            alt="HumanRobot"
            className="z-50 absolute size-[130px] top-[196px] left-[152px] md:hidden"
          />
        </div>

        <div className="hidden sm:flex sm:flex-col sm:gap-[85px] sm:items-end order-2 z-50 md:mt-[67px] md:mr-[23px] xx:h-[605px] xx:justify-start bb:h-[729px] bb:mt-[208px] bb:mr-[24px] bb:gap-[114px] bb:justify-start">
        ...
        <div className="z-50 flex flex-col items-start mt-[72px] ml-[3px] sm:hidden">
