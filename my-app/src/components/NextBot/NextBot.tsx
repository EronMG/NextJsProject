...
const NextBot = () => {
  return (
    <section className='px-[10px] pt-20 xx:pt-[171px]'>
      ...
      <div className='flex flex-col items-center pt-[10px] md:pt-5'>
      ...
      <div className='pt-[14px] flex flex-col items-center mm:pt-5 xx:pt-[26px]'>
        <p className=' text-[14px] text-dark font-Regular text-center leading-[18.2px] mm:text-base xx:leading-[26px] md:w-[479px] md:text-[20px]'>
