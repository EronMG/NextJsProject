...
const Steps = () => {
  ...
  return (
    <div className='lg:flex justify-center xm:justify-start xb:justify-center md:justify-center md:flex bb:justify-center md:mt-[380px] md:ml-[45px]'>
      <section className='pl-[10px] pt-[84px] md:w-[815px] xx:pl-0 lg:w-fit lg:relative overflow-hidden xx:mt-[285px] xx:pt-0 xx:w-[1657px] xx:max-w-[1657px] xm:max-w-[1400px] lg:max-w-[1280px]'>
        <div className='relative flex flex-col justify-center md:items-start md:pl-10 items-center lg:hidden'>
          <h2 className='text-dark text-[22px] font-Regular text-center pr-[10px] md:pr-0 md:text-start md:text-[18px] md:leading-[21.6px] leading-[26.4px]'>
          ...
          <img
            ...
            } absolute top-[5px] w-[310px] h-[235px] scale-125 md:-top-[9px] md:w-[411px] md:h-[144px] md:scale-100 md:object-cover md:left-[344px]`}
          />
        </div>
        <div className='flex flex-wrap gap-5 pt-[148px] mt-[4px] md:justify-center md:hidden md:pt-[240px]'>
          {stepsArr.map((item, _) => (
            <div
              key={item.id}
              className='flex flex-col gap-[10px] md:max-w-[300px]'
            >
              <div className='flex justify-center items-center bg-blue w-[72px] h-[45px] ml-[4px] rounded-[10px] relative'>
        ...
        <div className='hidden lg:flex flex-col xx:hidden pt-[67px] pl-[1px]'>
          <div className='flex gap-[30px]'>
            {stepsArr.slice(0, 2).map((item, _) => (
              ...
              >
                <div className='flex justify-center items-center bg-blue pt-1 w-[72px] min-h-[45px] rounded-[10px] relative'>
          ...
          <div className='flex justify-end xm:ml-[340px] pr-[6px] pt-[60px]'>
            {stepsArr.slice(2, 5).map((item, _) => (
              ...
              >
                <div className='flex justify-center items-center bg-blue pt-1 w-[72px] h-[45px] rounded-[10px] relative'>
                  <p className=' text-white font-Regular text-[40px]'>
                    {item.count}
                  </p>
                </div>
