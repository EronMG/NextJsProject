    ...
    <section className='bg-dark rounded-[40px] pt-[30px] pb-[33px] mx-[10px] mt-[78.5px] overflow-hidden'>
      <div className='px-[10px]'>
        <div className='flex flex-col gap-[10px]'>
          <div className='border-b-[2px] border-white flex justify-center'>
            <img src={NEXTBOT.src} alt='nextbot' className='md:w-[45%]' />
          </div>
          <div className='md:flex justify-center'>
            <h2 className='text-white font-Regular leading-[28.6px] text-center text-[22px] md:max-w-[454px] '>
        ...
        <div>
          <div className='hidden md:flex pt-20 relative max-w-[728px] mx-auto'>
            <img
              src={LineMain.src}
              alt='line'
              className='scale-[92%] absolute'
            />
            <p className='text-white font-Regular leading-[19.2px] text-[16px] md:max-w-[240px] absolute left-8 top-11'>
              ИИ-консультант обработал{' '}
              <span className='text-lime italic'>
                <br className='md:hidden' />
                440 обращений
        ...
        <div className='flex flex-col gap-[10px] pt-7 md:gap-6 md:pt-40 md:max-w-[728px] md:mx-auto'>
          <p className='text-white text-sm bg-[#1E2121] rounded-[10px]  font-Regular leading-[18.2px] pt-3 pl-[13px] pb-[9px] pr-2 md:max-w-[500px] md:text-base'>
        ...
        <div className='pt-[45.5px]'>
          <div className='flex flex-col md:flex-row-reverse items-center md:justify-center '>
            <div className='flex flex-col gap-7'>
              <div className='flex flex-col items-end justify-end'>
                <div className='relative flex justify-end pr-[15px] w-[280px] md:w-[395px]'>
                  <p className='w-[237px] md:w-[354px] z-50 md:z-20 text-base font-Regular leading-[20.8px] pl-[14px] pt-[7px] pb-[5px] pr-[18px] text-white bg-blue rounded-[10px] md:text-[24px] md:leading-[26px]'>
            ...
            <div className='md:relative md:w-[500px] md:justify-end md:flex'>
              <img
                ...
                alt='image'
                className='rounded-[10px] w-[280px] h-[183px] absolute opacity-70 left-0 hidden md:flex'
              />
              <img
                src={Hands.src}
                alt='icon'
                className='mt-4 ml-[6px] md:scale-125 md:mt-10'
              />
            </div>
          </div>
          ...
          <div className=' justify-center hidden md:flex'>
            <div className='pt-[30px] flex-wrap ss:items-center md:pt-10 md:w-[428px] hidden md:flex gap-1'>
              {helpArr.map((item, _) => (
                <p
                  key={item.id}
                  className={`${
      ...
      <div className='pt-10 relative'>
        ...
        <div className='pt-[82px] flex flex-col gap-[14px] items-center'>
          <h3 className='text-base leading-[20.8px] text-white  text-center font-Regular md:text-xl md:max-w-[721px] md:text-start'>
          ...
          <img
            src='https://s3-alpha-sig.figma.com/img/cba6/7c30/673c2f4819285845035110e2f532ff98?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=VjrwpkZYEANX8-H9-uFxjHm~bcpwK9AHbZ1-nGFbC8Xktdd9v1K54CyNWNCE-TJXyeZl98Be34hPZJM5nUgJ8CsHr2Ws6CeTvwXdUacceBcqfAbnaOKgKrDB-Jg3-4c7AkdgbnKeCgxka-5x9HoMZ0I0J-0ic-aVA95xjiBwjthw6r1o6aYR6eOTZOnmp7ebRar8fzduuKrVeAIX9CQKMgCjDhUCzPc7Fr5sDWlsIReROpWBtUyPfZzpjjQ6DSxmrBrZ~QudZsX5WLIkzAhHobIviWkJluaaoNdb0ghfzs4VjB8o-1YGK5olcvXRL6XcCgKZ9Z3tS18Y~8BvBFdHKQ__'
            alt='image'
            className='rounded-[10px] max-w-[280px] max-h-[183px] md:max-w-[679px] md:max-h-[445px] md:mr-10'
          />
        </div>
      </div>
      <div className='px-[10px] pt-[30px]'>
        ...
        <div className='flex flex-wrap gap-[10px] md:justify-center md:pt-7'>
          {helpArrBlock.map((item, _) => (
            <div
              key={item.id}
              className={`${
                item.id === 1 ? 'border-[1px] border-lime' : ''
              } rounded-[20px] p-2 bg-[#1E2121] max-w-[512px] md:p-5`}
            >
              ...
              <div className='pt-[10px] flex flex-col gap-2'>
                {item.titleArr.map((item, _) => (
                  <span
                    key={item.id}
                    className='flex items-start justify-start gap-1 text-white font-[12px] leading-[15.6px] font-Regular'
                  >
      ...
      <div className='px-[10px] flex flex-wrap  justify-start ss:justify-center gap-[14px] pt-8'>
