...
const Help = () => {
  ...
  return (
    <div className='xx:flex justify-center lg:relative' id='case'>
      <section className='bg-dark md:mx-[25px] md:mt-[60px] md:relative lg:static md:rounded-[24px] rounded-[40px] pt-[30px] pb-[33px] mx-[10px] xx:mr-[26px] xx:rounded-[60px] mt-[78.5px] overflow-hidden xx:mt-[175px] xx:w-[1738px]'>
        <div className='px-[10px]'>
          ...
          <div className='xx:pt-[118px]'>
            <div className='hidden md:flex pt-20 md:pt-[53px] relative max-w-[728px] xx:max-w-[1575px] mx-auto'>
              <img
                src={LineMain.src}
                alt='line'
                className='scale-[92%] absolute md:scale-[82.5%] md:top-[59px] xx:max-w-[1440px] xx:scale-[100%] xx:left-[74px] xx:top-[142px]'
              />
              <p className='text-white font-Regular md:text-[18px] md:leading-[21.6px] md:max-w-[198px] leading-[19.2px] text-[16px] md:text-center md:top-[-3px] md:left-11 absolute left-8 top-11 xx:leading-[43.2px] xx:text-[36px] xx:max-w-[495px] xx:text-center'>
                ИИ-консультант обработал{' '}
                <span className='text-lime italic'>
                  <br className='md:hidden' />
                  440 обращений
              ...
              <img
                ...
                src='https://s3-alpha-sig.figma.com/img/4be6/c15e/79d43dd925d1f844dce8930a03e43f91?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=q8nUcuxgLUUdb4qbSLhaFINh4JQhbKrAaNa~BASSG8B3do16DDs7KC~EL00mzdoRM43Br~x5t4V066n-qd5TItrEY7fhDyHbsqQ5bSO2yGsAgEh7ltLoNCPjEZ6iHaaWCfEjjPuVqYUyEA0u9g4JaLQqe9RuCyL9ywCCC20LoP-cTna7m054ZS3aYEgIbM0jUoYNUpXgwQ0sp3qDWQlDzbwC-j3BiVPXmz2A7LVC7q8chVB9YEW-s08JDZFYnjKUdJadMQeDK7IsQWsRdGxR3~W0Le6v~Nnaj4-guhiao8tUC6G-2-hb-PmD5Ht2v1qh9VnrHMtMyasmWyJ-hxQDJw__'
                alt='icon'
                className={`w-[280px] absolute left-[230px] md:w-[229px] md:left-[240px] md:top-[-23px] xx:w-[574px] xx:left-[522px] xx:top-[-90px] rotate-12 top-[-25px] ${
                  isVisible ? 'fade-in-out3' : ''
                }`}
              />
              <p className='text-white md:mr-[46px] font-Regular xx:absolute xx:right-[122px] xx:top-[85px] md:max-w-[145px] md:text-center md:text-[18px] md:leading-[21.6px] leading-[19.2px] w-[125px] text-end text-[16px] xx:leading-[43.2px] xx:text-[36px] xx:max-w-[289px] xx:w-[289px] xx:text-center md:w-[205px] absolute right-[25px] bottom-[-27px]'>
                сэкономил почти <span className='text-lime'>50 000 ₽</span>
              </p>
            </div>
          </div>
          <div className='xx:flex justify-center xx:w-[1706px]'>
            <div className='flex flex-col gap-[10px] pt-7 md:gap-[11px] md:pt-[150px] md:items-center xx:items-center md:max-w-[728px] md:mx-auto xx:pt-[400px] xx:max-w-[100%] xx:mx-0 xx:w-[1706px]'>
              <p
                ...
                leading-[18.2px] pt-3 pl-[13px] pb-[9px] pr-2 md:max-w-[307px] xx:max-w-[762px] xx:text-[22px] xx:leading-[28.6px]'
              >
                В декабре мы продавали настоящие елки. За две недели{' '}
                <br className='hidden md:flex xl:hidden' /> до Нового года спрос
              ...
              <div className='md:flex justify-end'>
                <p
                  className='text-white text-sm md:text-[10px] md:ml-[230px] md:h-[38px] lg:h-fit md:p-0 md:pr-2 md:flex md:justify-center md:items-center md:text-end md:leading-[13px] bg-[#1E2121] rounded-[10px]  font-Regular xx:ml-[356px] xx:py-[18px] xx:pr-[22px]
                  xx:mt-[17px] leading-[18.2px] pt-3 pl-[13px] pb-[9px] pr-2 md:max-w-[329px] xx:text-end xx:max-w-[716px] xx:text-[22px] xx:leading-[28.6px] '
                >
          ...
          <div className='pt-[45.5px] xx:pt-[88px] md:pt-[44px]'>
            <div className='flex flex-col md:flex-row-reverse items-center md:justify-center xx:justify-start xx:mr-[49px]'>
              <div className='flex flex-col gap-7 '>
                <div className='flex flex-col items-end md:items-start justify-end'>
                  <div className='relative flex justify-end pr-[15px] md:mr-[34px] w-[280px] md:w-[225px] xx:w-[500px] xx:mt-[89px]'>
                    <p
                      className='w-[237px] md:w-[181px] md:pt-3 md:pl-[11px] md:pb-[6px] md:pr-0 z-50 md:z-20 text-base font-Regular leading-[20.8px] pl-[14px] xx:pb-[23px] pt-[7px] pb-[5px] pr-[18px] text-white xx:pt-[29px] xx:pl-[30px] xx:w-[484px] bg-blue 
                      rounded-[10px] md:text-[14px] md:leading-[18.2px] xx:text-[36px] xx:leading-[46.8px] xx:rounded-[20px]'
                    >
                  ...
                  <div className='md:flex flex-col items-end gap-[10px] md:ml-7 md:gap-[6px] md:items-start hidden xx:items-start xx:gap-[23px] xx:pt-10 md:mt-3'>
                    <p className='text-[14px] text-white font-Regular leading-[18.2px] md:text-[10px] md:leading-[13px] md:text-start md:max-w-[170px] xx:text-[22px] xx:pl-2 xx:leading-[28.6px] xx:max-w-[434px]'>
                      Поставили ИИ-боту задачу – собрать все необходимые данные
                      для оформления доставки.
                    </p>
                    <p className='text-[14px] text-white font-Regular leading-[18.2px] md:text-[10px] md:leading-[13px] md:text-start md:max-w-[203px] xx:text-[22px] xx:pl-2 xx:leading-[28.6px] xx:max-w-[507px]'>
              ...
              <div className='md:relative md:w-[500px] md:ml-4 md:justify-end md:flex xx:mr-11 xx:pt-[30px]'>
                <img
                  ...
                  alt='image'
                  className='rounded-[10px] w-[280px] h-[183px] md:w-[253px] md:ml-[18px] md:top-8 md:h-[165px] absolute opacity-70 left-0 hidden md:flex xx:min-w-[632px] xx:min-h-[414px] xx:left-[-542px] xx:top-[93px] xx:rounded-[20px]'
                />
                <img
                  src={Hands.src}
                  alt='icon'
                  className='mt-4 ml-[6px] md:w-[285px] z-50 md:mt-7 xx:min-w-[713px] xx:min-h-[506px] xx:scale-100'
                />
              </div>
            </div>
            ...
            <div className=' justify-center hidden md:flex xx:pt-[46px] xx:pl-[280px]'>
              <div className='pt-[30px] flex-wrap ss:items-center md:pt-8 md:ml-[210px] md:w-[428px] hidden md:flex gap-1 xx:gap-2 xx:w-[780px]'>
                {helpArr.map((item, _) => (
                  <p
                    key={item.id}
                    className={`${
                      item.id === 1
                        ? 'text-blue text-[16px] md:text-[18px] md:mb-[4px] md:pt-[4px] md:leading-[23.4px] md:h-[20px] italic font-Regular leading-[20.8px] px-[10px] xx:text-[36px] xx:leading-[46.8px] xx:pt-[10px] bg-cloud rounded-full xx:px-[23px] w-fit mb-4 h-[27px] xx:h-[51px] flex justify-center items-center'
                        : 'text-cloud text-[11px] md:text-[10px] md:leading-[13px] font-Regular md:h-[21px] leading-[15.6px] px-[10px] border-[1px] xx:text-[20px] xx:leading-[26px] xx:px-[23px] border-cloud  rounded-full w-fit mb-[5px] h-[27px] flex xx:h-[51px] justify-center items-center'
                    }`}
                  >
                    {item.title}
                  </p>
        ...
        <div className='pt-10 relative md:pt-[13px]'>
          ...
          />
          <div className='pt-[82px] flex flex-col md:ml-[252px] md:pt-0 md:items-start gap-[14px] md:gap-[6px] items-center xx:pl-[220px] xx:pt-6 relative'>
            <h3 className='text-base leading-[20.8px] text-white  text-center font-Regular md:text-[12px] md:leading-[15.6px] md:max-w-[721px] md:text-start xx:leading-[26px]'>
            ...
            <img
              src='https://s3-alpha-sig.figma.com/img/cba6/7c30/673c2f4819285845035110e2f532ff98?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=VjrwpkZYEANX8-H9-uFxjHm~bcpwK9AHbZ1-nGFbC8Xktdd9v1K54CyNWNCE-TJXyeZl98Be34hPZJM5nUgJ8CsHr2Ws6CeTvwXdUacceBcqfAbnaOKgKrDB-Jg3-4c7AkdgbnKeCgxka-5x9HoMZ0I0J-0ic-aVA95xjiBwjthw6r1o6aYR6eOTZOnmp7ebRar8fzduuKrVeAIX9CQKMgCjDhUCzPc7Fr5sDWlsIReROpWBtUyPfZzpjjQ6DSxmrBrZ~QudZsX5WLIkzAhHobIviWkJluaaoNdb0ghfzs4VjB8o-1YGK5olcvXRL6XcCgKZ9Z3tS18Y~8BvBFdHKQ__'
              alt='image'
              className='rounded-[10px] max-w-[280px] max-h-[183px] md:max-w-[385px] md:max-h-[252px] md:mr-10 xx:rounded-[20px]'
            />
          </div>
        </div>
        <div className='px-[10px] pt-[32px] xx:pl-[86px] xx:pt-[147px] md:pt-[100px] md:ml-[14px]'>
          <h2 className='text-white font-Regular text-base leading-[20.8px] md:text-[18px] md:leading-[23.4px] md:max-w-[499px] md:text-start text-center xx:text-[36px] xx:leading-[46.8px] xx:text-start'>
          ...
          <div className='flex flex-wrap md:hidden lg:flex gap-[10px] pt-4 md:justify-center md:pt-7 xx:justify-end xx:gap-5 xx:pr-[62px] xx:pt-10'>
            {helpArrBlock.map((item, _) => (
              <div
                key={item.id}
                className={`${
                  item.id === 1 ? 'border-[1px] border-lime' : ''
                } rounded-[20px] pt-[14px] md:max-w-[216px] md:h-[256px] pl-[13px] pb-[13px] bg-[#1E2121] max-w-[512px] md:p-5 xx:pt-[34px] xx:pl-[23px] xx:w-full xx:h-[345px]`}
              >
          ...
          <div className='md:flex hidden lg:hidden ml-[210px] flex-wrap gap-[10px] pt-4 md:justify-center md:pt-7 xx:justify-end xx:gap-5 xx:pr-[62px] xx:pt-10'>
            {helpArrBlock2.map((item, _) => (
              <div
                key={item.id}
                className={`${
                  item.id === 1 ? 'border-[1px] border-lime' : ''
                } rounded-[8px] pt-[9.5px] md:max-w-[216px] md:h-[256px] pl-[8px] pb-[13px] bg-[#1E2121] max-w-[512px]`}
              >
                {item.id === 1 ? (
                  <h2 className='text-lime text-base leading-[20.8px] md:text-[14px] md:leading-[18.2px] font-Medium w-[187px]  xx:text-xl xx:leading-[26px] xx:w-fit'>
        ...
        <div className='px-[10px] flex flex-wrap md:relative md:pb-3  justify-start ss:justify-center md:justify-start md:pl-6 md:pt-[72px] md:gap-[10px] gap-[14px] pt-12 xx:hidden'>
          <h2 className='text-lime text-base leading-[20.8px] md:text-[12px] md:leading-[15.6px] font-Regular text-center md:max-w-[216px] md:text-end h-fit'>
          ...
          <div className='relative ll:w-[300px]'>
            <div>
              <img
                src={Circle1.src}
                alt='icon'
                className='absolute left-[6px] top-[1px] md:scale-[115%] md:left-[14px] md:top-1'
              />
              <img src={Circle2.src} alt='icon' className=' md:w-[215px]' />
              <img
                src={AI.src}
                alt='icon'
                className='w-[88px] h-[80px] absolute top-[50px] left-[47px] md:w-[102px] md:h-[91px] object-cover md:left-14 md:top-[60px]'
              />
            </div>
            <div className='flex flex-col absolute top-10 ll:right-6 right-[-92px] md:top-[33px] md:right-[-172px]'>
              <div className='size-[13px] bg-cloud rounded-full flex justify-center md:size-2 items-center absolute top-[29px] left-[-5px]'>
                <div className='bg-blue size-[7px] rounded-full md:size-1' />
              </div>
              <p className='text-lime text-[20px] font-Bold uppercase absolute right-[-3px] top-[-23px] md:text-[42px] md:top-[-40px] md:right-[0] md:leading-[54.6px]'>
                на 80%
              </p>
              <img
                src={Line.src}
                alt='icon'
                className='w-[110px] h-[35px] md:hidden lg:flex'
              />
              <img
                src={LineMD.src}
                alt='icon'
          ...
          <div className='ll:flex flex-col gg:relative gg:top-[70px] ll:relative ll:top-0 justify-end md:absolute md:right-[20px] md:top-[176px]'>
            <p className='text-white text-[12px] leading-[15.6px] font-Regular w-[258px] lg:text-[14px] lg:w-[250px] md:w-[222px]'>
              ...
              <br className='hidden md:flex' /> на увеличение прибыли.
            </p>
            <p className='text-white text-[12px] leading-[15.6px] font-Regular w-[194px] pt-3 lg:text-[14px] lg:w-[220px] md:pt-2'>
        ...
        <div className='flex justify-center md:absolute md:left-[67px] md:bottom-[50px] lg:static xx:hidden'>
          <button
            className={`relative z-10 xx:hidden md:w-[153px] md:h-[30px] w-[234px] h-[50px] mt-[21px] lg:absolute left-0 lg:bottom-10 lg:left-[100px] flex flex-row items-center justify-center gap-2 pr-7 rounded-[40px] bg-lime ${
              isHovered ? 'button-hovered' : ''
            }`}
            onMouseEnter={handleMouseEnter}
            onMouseLeave={() => setIsHovered(false)}
