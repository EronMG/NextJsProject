...
const AnimatedHeading: React.FC<AnimatedHeadingProps> = () => {
  ...
  return (
    <h1
      ...
      } md:max-w-[1000px] max-w-[290px] text-[22px] leading-[26.4px] text-center font-Bold text-dark pl-2 mm:max-w-[522px] md:text-[32px] md:leading-[36.4px] lg:text-[42px] lg:leading-[50.4px]`}
    >
