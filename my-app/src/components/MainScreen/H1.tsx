...
const AnimatedHeading: React.FC<AnimatedHeadingProps> = () => {
  ...
  return (
    <h1
      ...
      } max-w-[290px] text-[22px] leading-[26.4px] text-center font-Bold text-dark mm:max-w-[543px] md:text-[22px] md:leading-[26.4px] xl:max-w-[1000px] xl:text-[42px] xl:leading-[50.4px]`}
    >
