    ...
    <>
      <section className='w-screen flex flex-col items-center overflow-hidden md:mt-[35px] lg:mt-[71px]'>
        <div className='z-10 flex flex-col items-center gap-3 mt-[15px]'>
          <h1 className='max-w-[1000px] min-w-[287px] text-[22px] leading-[26.4px] text-center font-Bold text-dark pl-2 md:text-[32px] md:leading-[36.4px] lg:text-[42px] lg:leading-[50.4px]'>
        ...
        <div className='flex flex-col items-center mt-[14px] md:grid md:grid-cols-2 md:gap-x-4 xl:hidden'>
          {[
